...
<html>
	<head>
		...
		<title>Cell | Campus Drives</title>
		<meta name="viewport"
...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyErricsson, Motorola web design" />
	...
	<body>
					...
					<div class="top-nav">
						...
						<ul class="nav1">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">Cell<i>Goto Placement Homepage</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
		...
		<div class="products-top">
			<!-- container -->
			<div class="container">
				<h3 class="wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">Companies Visiting Us</h3>
